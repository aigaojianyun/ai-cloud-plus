<template>
  <view class="container">
    <view class="page-body uni-content-info">
      <view class='cropper-content'>
        <view v-if="isShowImg" :style="'width:'+cropperInitW+'px;height:'+cropperInitH+'px;background:#000'"
          ...
          <view :style="'width:'+cropperW+'px;height:'+cropperH+'px;left:'+cropperL+'px;top:'+cropperT+'px'"
            ...
            <view :style="'left:'+cutL+'px;top:'+cutT+'px;right:'+cutR+'px;bottom:'+cutB+'px'" class="uni-corpper-crop-box" @touchstart.stop="contentStartMove"
      ...
      <canvas :style="'position:absolute;border: 1px solid red; width:'+imageW+'px;height:'+imageH+'px;top:-9999px;left:-9999px;'"
