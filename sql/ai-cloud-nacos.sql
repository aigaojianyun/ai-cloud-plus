...
) ENGINE = InnoDB AUTO_INCREMENT = 210 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of config_info
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'application-dev.yml', 'DEFAULT_GROUP', '# Spring\nspring:\n  autoconfigure:\n    exclude: com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceAutoConfigure\n  mvc:\n    pathmatch:\n      matching-strategy: ant_path_matcher\n\n# feign 配置\nfeign:\n  sentinel:\n    enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  client:\n    config:\n      default:\n        connectTimeout: 10000\n        readTimeout: 10000\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n', '006e6d01e7ad07365b2024776588d03e', '2022-08-29 07:50:04', '2023-02-13 08:52:35', 'nacos', '127.0.0.1', '', '', '通用配置', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (9, 'ai-cloud-user-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: password\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 用户账户服务接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n', 'd51fa3c91a4bbd078de881bb83a30c65', '2022-09-15 14:28:51', '2023-02-13 08:51:04', 'nacos', '127.0.0.1', '', '', '用户模块', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (10, 'ai-cloud-pay-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root  \n    password: password\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 支付服务接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n', '7fe8bf6b60c3e12e880383b4a4155290', '2022-09-16 08:20:56', '2023-02-13 08:51:46', 'nacos', '127.0.0.1', '', '', '支付模块', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (11, 'ai-cloud-resource-dev.yml', 'DEFAULT_GROUP', '# Spring\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared\n    \n#邮箱\nmail:\n  enabled: true\n  host: smtp.163.com\n  port: 465\n  # 是否需要用户名密码验证\n  auth: true\n  # 发送方，遵循RFC-822标准\n  from: aicloud888@163.com\n  # 用户名（注意：如果使用foxmail邮箱，此处user为qq号）\n  user: aicloud888@163.com\n  # 密码（注意，某些邮箱需要为SMTP服务单独设置密码，详情查看相关帮助）\n  pass: NELQQVQYIPMKKSMM\n  # 使用 STARTTLS安全连接，STARTTLS是对纯文本通信协议的扩展。\n  starttlsEnable: true\n  # 使用SSL安全连接\n  sslEnable: true\n  # SMTP超时时长，单位毫秒，缺省值不超时\n  timeout: 0\n  # Socket连接超时值，单位毫秒，缺省值不超时\n  connectionTimeout: 0\n\n#短信\nsms:\n  enabled: true\n  # 阿里云 dysmsapi.aliyuncs.com\n  # 腾讯云 sms.tencentcloudapi.com\n  endpoint: \"sms.tencentcloudapi.com\"\n  accessKeyId: AKIDSRGqBH8k6KGxPhkaBzZuzpQlrhNo0wgD\n  accessKeySecret: LRIvJRJwKSK0SfdLq67tRknbDahZBYgY\n  signName: 高建云小程序测试网\n  # 腾讯专用\n  sdkAppId: 511411', 'c1529c45e0f077b48e68435d02a9a183', '2022-10-28 02:46:11', '2023-01-31 09:34:44', 'nacos', '10.10.10.26', '', '', '资源服务', '', '', 'yaml', '', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 165 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;
