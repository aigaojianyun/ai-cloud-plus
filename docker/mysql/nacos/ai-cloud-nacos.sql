...
) ENGINE = InnoDB AUTO_INCREMENT = 134 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (2, 125, 'ai-cloud-gateway-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: ai-cloud-auth\n          uri: lb://ai-cloud-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            # 验证码处理\n            - CacheRequestFilter\n            - ValidateCodeFilter\n            - StripPrefix=1\n        # 监控中心\n        - id: ai-cloud-monitor\n          uri: lb://ai-cloud-monitor\n          predicates:\n            - Path=/monitor/**\n          filters:\n            - StripPrefix=1     \n        # 代码生成\n        - id: ai-cloud-gen\n          uri: lb://ai-cloud-gen\n          predicates:\n            - Path=/code/**\n          filters:\n            - StripPrefix=1\n        # 定时任务\n        - id: ai-cloud-job\n          uri: lb://ai-cloud-job\n          predicates:\n            - Path=/schedule/**\n          filters:\n            - StripPrefix=1\n        # 系统模块\n        - id: ai-cloud-system\n          uri: lb://ai-cloud-system\n          predicates:\n            - Path=/system/**\n          filters:\n            - StripPrefix=1\n        # 文件服务\n        - id: ai-cloud-file\n          uri: lb://ai-cloud-file\n          predicates:\n            - Path=/file/**\n          filters:\n            - StripPrefix=1\n        # 用户服务\n        - id: ai-cloud-user\n          uri: lb://ai-cloud-user\n          predicates:\n            - Path=/user/**\n          filters:\n            - StripPrefix=1    \n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: false\n    type: math\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /file/upload\n      - /auth/captcha/get\n      - /auth/captcha/check\n      - /auth/login\n      - /auth/logout\n      - /auth/register\n      - /auth/register/user\n      - /*/v2/api-docs\n      - /csrf\n', '374b9ec63b9815689df47c88b4205b41', '2022-11-05 15:39:52', '2022-11-05 07:39:52', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (3, 126, 'ai-cloud-auth-dev.yml', 'DEFAULT_GROUP', '', '# Spring\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared\n    \n# 滑块验证码\naj:\n  captcha:\n    # 滑动验证，底图路径，不配置将使用默认图片\n    jigsaw: classpath:images/jigsaw\n    # 滑动验证，底图路径，不配置将使用默认图片\n    pic-click: classpath:images/pic-click\n    # 缓存类型\n    cache-type: redis\n    # blockPuzzle 滑块 clickWord 文字点选  default默认两者都实例化\n    type: default\n    # 右下角显示字\n    water-mark: aiclouds.vip\n    # 校验滑动拼图允许误差偏移量(默认5像素)\n    slip-offset: 5\n    # aes加密坐标开启或者禁用(true|false)\n    aes-status: true\n    # 滑动干扰项(0/1/2)\n    interference-options: 2', '3e6633be236c30a3d22e142eaeca7b61', '2022-11-05 15:40:00', '2022-11-05 07:40:01', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (4, 127, 'ai-cloud-monitor-dev.yml', 'DEFAULT_GROUP', '', '# spring\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared\n  security:\n    user:\n      name: admin\n      password: 123456\n  boot:\n    admin:\n      ui:\n        title: 服务状态监控\n', '622924c79b2f52f3e02b29c56d9c98af', '2022-11-05 15:40:10', '2022-11-05 07:40:10', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (5, 128, 'ai-cloud-system-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared\n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n          # 主库数据源\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://rm-bp15521us1y063fs28o.mysql.rds.aliyuncs.com:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: aigaojianyun\n            password: Xka5201314\n          # 从库数据源\n          # slave:\n            # username: \n            # password: \n            # url: \n            # driver-class-name: \n      # seata: true    # 开启seata代理，开启后默认每个数据源都代理，如果某个不需要代理可单独关闭\n\n# seata配置\nseata:\n  # 默认关闭，如需启用spring.datasource.dynami.seata需要同时开启\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      ai-cloud-system-group: default\n  config:\n    type: nacos\n    nacos:\n      serverAddr: 127.0.0.1:8848\n      group: SEATA_GROUP\n      namespace:\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: 127.0.0.1:8848\n      namespace:\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml    \n\n# swagger配置\nswagger:\n  title: 系统模块接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip', 'da8a9458164f291feecb0895670e83de', '2022-11-05 15:40:44', '2022-11-05 07:40:45', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 129, 'ai-cloud-gen-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource: \n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://rm-bp15521us1y063fs28o.mysql.rds.aliyuncs.com:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: aigaojianyun\n    password: Xka5201314\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 代码生成接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n\n# 代码生成\ngen: \n  # 作者\n  author: ai-cloud\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\n  packageName: com.cloud.system\n  # 自动去除表前缀，默认是false\n  autoRemovePre: false\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\n  tablePrefix: sys_\n', '93d0a2ab08852cdaaa846ffb3556b37b', '2022-11-05 15:41:19', '2022-11-05 07:41:19', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (7, 130, 'ai-cloud-job-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://rm-bp15521us1y063fs28o.mysql.rds.aliyuncs.com:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: aigaojianyun\n    password: Xka5201314\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 定时任务接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n', '7358d918aab6395ced0863c4cff617be', '2022-11-05 15:41:53', '2022-11-05 07:41:53', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (9, 131, 'ai-cloud-user-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://rm-bp15521us1y063fs28o.mysql.rds.aliyuncs.com:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: aigaojianyun\n    password: Xka5201314\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 用户账户服务接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n', '01836fdc1b7b6e924b9e605411d9ea66', '2022-11-05 15:42:28', '2022-11-05 07:42:29', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (10, 132, 'ai-cloud-pay-dev.yml', 'DEFAULT_GROUP', '', '# spring配置\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://rm-bp15521us1y063fs28o.mysql.rds.aliyuncs.com:3306/ai-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: aigaojianyun\n    password: Xka5201314\n\n# mybatis plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.cloud.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath*:mapper/**/*Mapper.xml\n  # 加载全局的配置文件\n  #configLocation: classpath:mybatis/mybatis-config.xml  \n\n# swagger配置\nswagger:\n  title: 支付服务接口文档\n  license: Powered By cloud\n  licenseUrl: https://cloud.vip\n', '673af8f68c58ecfd88a8fa7cffaf2020', '2022-11-05 15:42:57', '2022-11-05 07:42:58', 'nacos', '192.168.2.6', 'U', '', '');
INSERT INTO `his_config_info` VALUES (11, 133, 'ai-cloud-resource-dev.yml', 'DEFAULT_GROUP', '', '# Spring\nspring: \n  redis:\n    host: 127.0.0.1\n    port: 6379\n    password: foobared\n    \n#邮箱\nmail:\n  enabled: false\n  host: smtp.163.com\n  port: 465\n  # 是否需要用户名密码验证\n  auth: true\n  # 发送方，遵循RFC-822标准\n  from: xxx@163.com\n  # 用户名（注意：如果使用foxmail邮箱，此处user为qq号）\n  user: xxx@163.com\n  # 密码（注意，某些邮箱需要为SMTP服务单独设置密码，详情查看相关帮助）\n  pass: xxxxxxxxxx\n  # 使用 STARTTLS安全连接，STARTTLS是对纯文本通信协议的扩展。\n  starttlsEnable: true\n  # 使用SSL安全连接\n  sslEnable: true\n  # SMTP超时时长，单位毫秒，缺省值不超时\n  timeout: 0\n  # Socket连接超时值，单位毫秒，缺省值不超时\n  connectionTimeout: 0\n\n#短信\nsms:\n  enabled: false\n  # 阿里云 dysmsapi.aliyuncs.com\n  # 腾讯云 sms.tencentcloudapi.com\n  endpoint: \"dysmsapi.aliyuncs.com\"\n  accessKeyId: xxxxxxx\n  accessKeySecret: xxxxxx\n  signName: 测试\n  # 腾讯专用\n  sdkAppId:', '1383af3e26be616d723c0a2cf5ca4e58', '2022-11-05 16:27:52', '2022-11-05 08:27:52', 'nacos', '192.168.2.6', 'U', '', '');
